-- CyberRoulette — Docker entrypoint init script
-- Runs automatically on first container start via /docker-entrypoint-initdb.d/
--
-- Note: POSTGRES_DB from docker-compose already creates the database,
-- so this script only needs to create the schema objects.
